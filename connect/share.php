		...
		foreach ($zresults as $zrow) {
			...
			foreach ($zresultsmolds as $zrowmolds) {
				...
				$zmolds[$zmold] = array(
					...
					'physicsenabled'=>$zrow["physicsenabled"],
					'physicscenterx'=>$zrow["physicscenterx"],
					'physicscentery'=>$zrow["physicscentery"],
					'physicscenterz'=>$zrow["physicscenterz"],
					'physicsextentsx'=>$zrow["physicsextentsx"],
					'physicsextentsy'=>$zrow["physicsextentsy"],
					'physicsextentsz'=>$zrow["physicsextentsz"],
					'physicsfriction'=>$zrow["physicsfriction"],
					'physicsistriggershape'=>$zrow["physicsistriggershape"],
					'physicsmass'=>$zrow["physicsmass"],
					'physicspointax'=>$zrow["physicspointax"],
					'physicspointay'=>$zrow["physicspointay"],
					'physicspointaz'=>$zrow["physicspointaz"],
					'physicspointbx'=>$zrow["physicspointbx"],
					'physicspointby'=>$zrow["physicspointby"],
					'physicspointbz'=>$zrow["physicspointbz"],
					'physicsradius'=>$zrow["physicsradius"],
					'physicsrestitution'=>$zrow["physicsrestitution"],
					'physicsrotationx'=>$zrow["physicsrotationx"],
					'physicsrotationy'=>$zrow["physicsrotationy"],
					'physicsrotationz'=>$zrow["physicsrotationz"],
					'physicsrotationw'=>$zrow["physicsrotationw"],
					'physicsstartasleep'=>$zrow["physicsstartasleep"],
